...
public class CommentController {
    ...
    public ResponseEntity<CommentResponseDto> createComment(
            @AuthenticationPrincipal UserDetailsImpl user, @RequestBody CommentRequestDto req,
    ...
    public ResponseEntity<CommentResponseDto> updateComment(
        ...
        return ResponseEntity.ok()
                .body(commentService.updateComment(user.getUser(), req, commentId));
    }

    @DeleteMapping("/comment/commentId/{commentId}")
    public ResponseEntity<Void> deleteComment(@AuthenticationPrincipal UserDetailsImpl user,
            @PathVariable Long commentId) {
        commentService.deleteComment(user.getUser(), commentId);
